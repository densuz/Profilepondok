...
class M_slide extends CI_model{
	...
	function simpan_slide($slide_gambar, $slide_judul, $slide_caption){
		$hsl=$this->db->query("INSERT INTO tbl_slide (slide_judul, slide_caption, slide_gambar) VALUES ('$slide_judul','$slide_caption','$slide_gambar')");
        return $hsl;
