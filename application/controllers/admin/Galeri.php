...
class Galeri extends CI_Controller{
	...
	function simpan_galeri(){
				$config['upload_path'] = './theme/images/galeri/'; //path folder
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
	                        ...
	                        $config['source_image']='./theme/images/galeri/'.$gbr['file_name'];
	                        $config['create_thumb']= FALSE;
	                        $config['maintain_ratio']= FALSE;
	                        $config['quality']= '60%';
	                        $config['width']= 500;
	                        $config['height']= 400;
	                        $config['new_image']= './theme/images/galeri/'.$gbr['file_name'];
	...
	function hapus_galeri(){
		...
		$path='./theme/images/galeri/'.$gambar;
		unlink($path);
