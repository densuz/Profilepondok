...
class Album extends CI_Controller{
	...
	function simpan_album(){
				$config['upload_path'] = './theme/images/cover_album/'; //path folder
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
	                        ...
	                        $config['source_image']='../theme/images/cover_album/'.$gbr['file_name'];
	                        $config['create_thumb']= FALSE;
	                        $config['maintain_ratio']= FALSE;
	                        $config['quality']= '60%';
	                        $config['width']= 500;
	                        $config['height']= 400;
	                        $config['new_image']= './theme/images/cover_album/'.$gbr['file_name'];
	...
	function hapus_album(){
		...
		$path='./theme/images/cover_album/'.$gambar;
		unlink($path);
