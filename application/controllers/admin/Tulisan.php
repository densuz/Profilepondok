...
class Tulisan extends CI_Controller{
	...
	function simpan_tulisan(){
				$config['upload_path'] = './assets/images/cover_tulisan/'; //path folder
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
	                        ...
	                        $config['source_image']='./assets/images/cover_tulisan/'.$gbr['file_name'];
	                        $config['create_thumb']= FALSE;
	                        $config['maintain_ratio']= FALSE;
	                        $config['quality']= '60%';
	                        $config['width']= 710;
	                        $config['height']= 460;
	                        $config['new_image']= './assets/images/cover_tulisan/'.$gbr['file_name'];
	...
	function hapus_tulisan(){
		...
		$path='./assets/images/cover_tulisan/'.$gambar;
		unlink($path);
