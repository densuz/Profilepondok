 ...
 <h2 style="text-align: center;"><b>Data Diri Pendaftar</b></h2>
                ...
                <form class="form-horizontal" action="<?php echo base_url().'pendaftaran/daftar/simpan_pendaftaran'?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2" >
                                        <img width="150" height="200" src="<?php echo base_url().'./assets/images/'.$form_foto;?>">
                       ...
                       <div align="center" >
                        ...
                        <hr>
                           ...
                           <div class="col col-md-3">
                               <a class="btn btn-warning" href="<?php echo base_url().'admin_psb/daftar_lolos'?>"><i class="fa fa-back"></i> Kembali</a>
                           </div>
