              ...
              <?php foreach ($data->result() as $row) : ?>
                <div class="blog-single-item">
                    <div class="blog-img_block">
                        <img src="<?php echo base_url().'assets/images/cover_tulisan/'.$row->tulisan_gambar;?>" class="img-fluid" alt="blog-img">
                        <div class="blog-date">
                ...
                <div class="blog-featured_post">
                    ...
                    <?php foreach ($populer->result() as $row) :?>
                      <div class="blog-featured-img_block">
                          <img width="35%" src="<?php echo base_url().'assets/images/cover_tulisan/'.$row->tulisan_gambar;?>" class="img-fluid" alt="blog-featured-img">
