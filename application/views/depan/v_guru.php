        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="admission_insruction">
                  <?php if(empty($foto)):?>
                    <img src="<?php echo base_url().'../akademikpondok/assets/images/blank.png';?>" class="img-fluid" alt="#">
                <?php else:?>
                    <img src="<?php echo base_url().'../akademikpondok/assets/images/foto_guru/'.$foto;?>" class="img-fluid" alt="#">
                <?php endif;?>
