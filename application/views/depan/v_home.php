...
<!--     <style type="text/css">
        .detailed_chart{
            background: url('theme/images/footer_bg.png') no-repeat;
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active">
                        <img width="auto" height="" class="d-block" src="<?php echo base_url().'theme/images/foto_slide/'. $slide_gambar?>" alt="First slide" >
...
<div class="carousel-item">
                        <img class="d-block" src="<?php echo base_url().'theme/images/foto_slide/'. $slide_gambar?>" alt="First slide" >
                        <div class="carousel-caption d-md-block">
                            <div class="slider_title">
                                <h1><?php echo $slide_judul; ?></h1>
                                <h4><?php echo $slide_caption; ?></h4>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="courses_box mb-4">
                    <div class="course-img-wrap">
                        <img src="<?php echo base_url().'assets/images/cover_tulisan/'.$row->tulisan_gambar;?>" class="img-fluid" alt="courses-img">
                    </div>
                    <!-- // end .course-img-wrap -->
