        ...
        <div class="row">
         <?php foreach ($all_galeri->result() as $rows) : ?>
          <?php if($row->album_id == $rows->galeri_album_id){ ?>
            <div class="col-sm-4">
          <a href="<?php echo base_url().'theme/images/galeri/'.$rows->galeri_gambar;?>" class="image-link2">
             <img src="<?php echo base_url().'theme/images/galeri/'.$rows->galeri_gambar;?>" class="all img-fluid" alt="#" />
            </a>
          </div>
          <?php }?>
         <?php endforeach;?>
