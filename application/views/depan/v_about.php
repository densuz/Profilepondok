...
<section class="welcome_about">
    <div class="container">
        <div class="row">
            <div class="col-md-7" style="margin-bottom: -200px;">
                <h2>Visi Misi</h2>
                <p>
                     <ul>VISI
                        <ul>
                ...
                <div class="col-md-5">
                    <img src="<?php echo base_url().'theme/images/logo.jpg'?>" class="img-fluid" alt="#">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="margin-top: -20px;">
                ...
                <!--<div class="col-md-5">
                    <img src="<?php echo base_url().'theme/images/logo1.jpg'?>" class="img-fluid" alt="#">
                </div> -->
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="single-item">
                        <?php foreach ($all_testimoni->result() as $row) : ?>
                        <div class="quote">
                            
                                
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <p class="quote_text"><?php echo $row->testimoni_isi;?>
                           </p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/foto_testi/'.$row->testimoni_gambar;?>" class="img-fluid" alt="#">
                                <p><span><?php echo $row->testimoni_nama;?></span></p>
                            </div>
                        </div>
                        <?php endforeach;?>
