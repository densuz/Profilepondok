...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'asharifauzan29@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Ashari'; // Isikan dengan nama pengirim
    ...
    public function send($data){
        ...
        $mail->Username = 'asharifauzan29@gmail.com'; // Email Pengirim
